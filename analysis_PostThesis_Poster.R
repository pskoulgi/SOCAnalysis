...
# Processing and plotting ...
{
  ...
  #ggsave("figs/SoilC_CTvsFRCompare_Poster.png", bg = "transparent")
  ...
  ggplot(sirMeans, aes(y=MEAN, x=SITE.TYPE, fill=SITE.TYPE)) + theme_classic() +
    ...
    scale_x_discrete(labels=
                       c("\n Contiguous \n forests", "\n Fragmented \n forests")) +
    ylab(expression(atop("Soil SIR", (paste(mu, "g C-", CO[2], " ", g^{-1}, " ", hr^{-1}))))) +
  ...
  #ggsave("figs/SIR_CTvsFRCompare_YlabFixCol.png")
  ...
  ggsave("figs/SoilCvsSites_YlabFixCol.png")
  ...
  ggplot(cCycle, aes(y=SOIL.SIR, x=SITE.ID, fill=SITE.TYPE)) +
    ...
    scale_fill_manual(values = c("#E69F00", "#D55E00"))
    #scale_fill_grey(labels=c("Contiguous", "Fragment"), start=0.5)
  ggsave("figs/SIRvsSites_YlabFixCol.png")
  ...
  ggplot(littWtMeans, aes(y=MEAN, x=SITE.TYPE, fill=SITE.TYPE)) + theme_classic() +
    ...
    scale_x_discrete(labels=
                       c("\n Contiguous \n forests", "\n Fragmented \n forests")) +    
    ylab(expression(atop("Litter weight", (paste(g, " ", m^{-2}))))) +
    theme(legend.title=element_blank(),
          axis.title.x=element_blank(), 
          axis.ticks.x=element_blank(),
          axis.line.x = element_line(colour = 'black', size=0.5, linetype='solid'),
          ...
          panel.background = element_rect(fill = "transparent",colour = NA)) +
    scale_fill_manual(values = c("#E69F00", "#D55E00"))
  ggsave("figs/LittWt_CTvsFRCompare_YlabFixCol.png", bg = "transparent")
  ...
  ggplot(littCNMeans, aes(y=MEAN, x=SITE.TYPE, fill=SITE.TYPE)) + theme_classic() +
    ...
    theme(legend.title=element_blank(),
          ...
          panel.background = element_rect(fill = "transparent",colour = NA)) +
    scale_fill_manual(values = c("#E69F00", "#D55E00"))
  ggsave("figs/LittCN_CTvsFRCompare_YlabFixCol.png", bg = "transparent")
  ...
  ggsave("figs/SoilCvsLitterCN_SiteAvgs_YlabFixCol.png")
  ...
  ggplot(soilNLittMeans, aes(y=SOIL.C.MEAN, x=LITTER.P.MEAN,
    ...
    theme(legend.title=element_blank(),
          ...
          panel.background = element_rect(fill = "transparent",colour = NA))
    #scale_color_grey(labels=c("Contiguous", "Fragment"))
  ggsave("figs/SoilCvsLitterP_SiteAvgs_YlabFixCol.png")
  ...
  ggplot(soilNLittMeans, aes(y=SOIL.C.MEAN, x=LITTER.WT.MEAN,
    ...
    geom_errorbar(aes(ymin=SOIL.C.MEAN-(SOIL.C.SE),
                      ymax=SOIL.C.MEAN+(SOIL.C.SE)), width=0) +
    xlab(expression(atop("Litter weight", (paste(g, " ", m^{-2}))))) +
    ylab("Soil %C") +
    theme(legend.title=element_blank(),
          legend.text = element_text(size = 15),
          axis.line.x = element_line(colour = 'black', size=0.5, linetype='solid'),
          ...
          panel.background = element_rect(fill = "transparent",colour = NA))
    #scale_color_grey(labels=c("Contiguous", "Fragment"))
  ggsave("figs/SoilCvsLitterWt_SiteAvgs_YlabFixCol.png")
  ...
  ggplot(soilNLittMeans, aes(y=SOIL.C.MEAN, x=BAS.AREA.MEAN,
    ...
    theme(legend.title=element_blank(),
          ...
          panel.background = element_rect(fill = "transparent",colour = NA))
    #scale_color_grey(labels=c("Contiguous", "Fragment"))
  ggsave("figs/SoilCvsBasArea_SiteAvgs_YlabFixCol.png")
  ...
  ggplot(littQualCompare, aes(y=LITT.CTON.MEAN, x=NAME, fill=SITE.TYPE)) +
    ...
    theme(legend.position = "none",
          ...
          axis.line.x = element_line(colour='black',size=0.5,linetype='solid'),
          axis.line.y = element_line(colour='black',size=0.5,linetype='solid'),
          axis.title.y = element_text(size = 20, angle = 0, margin=margin(0,20,0,0)),
    ...
    scale_x_discrete(labels=
                       c("\n Community \n weighted \n average", "\n Sample \n average")) +
    scale_fill_manual(values = c("#E69F00", "#D55E00"), 
                      labels = c("Contiguous", "Fragment"))
  ggsave("figs/LittQualCompare_CommVsSampleAvg_YlabFixCol.png", bg = "transparent")
  ...
  ggplot(treeStemPropsMeans, aes(y=MEAN, x=SIZE.CLASS, fill=SITE.TYPE)) +
    ...
    xlab("\n Diameter (cm) at breast height (DBH) class") + 
    ylab("Proportion \n of stems") +
    ylim(0,0.4) +
    theme(legend.position="none",
          #legend.title=element_blank(),
    ...
    scale_fill_manual(values = c("#E69F00", "#D55E00"), 
                      labels = c("Contiguous", "Fragment"))
  ggsave("figs/TreeSizeClassDistr_PropStems_YlabFixCol.png", bg = "transparent")
